...
import com.advanz101.quickaction.R;
...
public class FilterAdapter extends BaseExpandableListAdapter {
    ...
    private static final String LOG_TAG = FilterAdapter.class.getSimpleName();
    private List<FilterModel> countries;
    ...
    public FilterAdapter(Context context, List<FilterModel> countries) {
        this.countries = countries;
        inflater = LayoutInflater.from(context);
        checkedPositions = new SparseArray<SparseBooleanArray>();
    }

    public FilterAdapter(Context context, List<FilterModel> countries, int choiceMode) {
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView,
        ...
        AppCompatCheckedTextView checkedTextView = convertView.findViewById(R.id.expandedListItem);
